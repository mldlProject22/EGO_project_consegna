...
parser.add_argument('--p', type=float, default = 0.5 ,  help='dropout prob')
...
parser.add_argument('--loss_weights', type=float, default=[1, 1, 1],nargs="+",
                    help='losses')                   

parser.add_argument('--source', type=str, default="none",
                    help='grid search for source parameters ')
